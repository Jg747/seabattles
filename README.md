...
+ `gui={type}`: selects which GUI is used
    + `gui=jfx`: JavaFX GUI (default)
    + `gui=ascii`: terminal GUI

# Installation
Download repository and switch to the Java branch
```
...
## Compile (executable)
Compile and create executable in `dest` folder
`mvn clean package jpackage:jpackage`

## Import and execute
Import project in your IDE and run as JavaFX application with main method in the `org.seabattles.src.Main` package