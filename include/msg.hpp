...
typedef struct player_info ack_player_get_own_id;
...
typedef struct match_stats_t ack_match_end;

typedef struct player_info ack_invalid_ship_placement;
...
typedef struct player_info ack_match_not_host;

typedef struct player_info ack_match_not_dead;
...
typedef struct match_stats_t match_end, match_win, match_lose;
...
struct msg {
	...
	union {
		...
		ack_player_get_own_id ack_player_get_own_id;
		...
		ack_match_end ack_match_end;
		ack_invalid_ship_placement ack_invalid_ship_placement;
		struct ack_match_attack_err ack_match_attack_err;
		ack_match_not_host ack_match_not_host;
		ack_match_not_dead ack_match_not_dead;
