...
public class Board implements BoardInterface {
	...
	public Board(Map<Integer, ShipConfig> shipsConfig) {
		ships = new TreeMap<>();
		for (Integer i : shipsConfig.keySet()) {
			ships.put(i, new Ship(shipsConfig.get(i)));
		}
		
		shipsRemaining = (short) shipsConfig.size();
		createEmptyBoard();
	}
